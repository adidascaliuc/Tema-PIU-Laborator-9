...
namespace LibrarieModele
{
    public class Student
    {
        ...
        public Student(string linieFisier)
        {
            ...
            AnStudiu = Convert.ToInt32( dateFisier[(int)CampuriStudent.ANSTUDIU] );
        }
        ...
        public string ConversieLaSir()
        {
            ...
            string s = string.Format("Studentul cu Id: #{0} si numele: \"{1} {2}\", programul de studiu {3}, are notele:.... {4} la disciplinele {5} , in anul de studiu: {6}", IdStudent, (Nume ?? " NECUNOSCUT "), (Prenume ?? " NECUNOSCUT ") , ProgramSTD, sNote, DisciplineAsString, AnStudiu);
            return s;
        }
